            ...
            <div class="Wrapper_Box">
              <div class="sectionHeadingBox d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="tab_ButtonBox">
                  <a href="{{ route('sub-category-create') }}" class="editBtn"><i class="fa-solid fa-plus me-1"></i>
                    Add Sub Category</a>
                </div>
              </div>
                ...
                <table id="example" class="table display nowrap" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Active</td>
                      <td>
                        <a href="{{url('/admin/sub-category/edit')}}/{{1}}" class="editBTN" title="Edit">
                    ...
                    <tr>
                      ...
                      <td>Active</td>
                      <td>
                        <a href="{{url('/admin/sub-category/edit')}}/{{2}}" class="editBTN" title="Edit">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>  
                        <a href="javascript:void(0)" class="deleteBTN" title="Delete">
                          <i class="fa-solid fa-trash-can"></i>
                    ...
                    <tr>
                      ...
                      <td>Active</td>
                      <td>
                        <a href="{{url('/admin/sub-category/edit')}}/{{3}}" class="editBTN" title="Edit">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a> 
                        <a href="javascript:void(0)" class="deleteBTN" title="Delete">
                          <i class="fa-solid fa-trash-can"></i>
